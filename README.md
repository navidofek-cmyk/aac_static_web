...
| # | Název | Obsah |
|---|---|---|
| 1 | **Slabiky** | Všechny české souhlásky (M,L,S,P,T,V,B,N,D,K,J,R,F,G,H,CH,Z,Ž,Š,Č,C,Ř) — ke každé slabice pěkné české slovo (balón, beruška, medvěd…), v fokus módu klikatelné |
